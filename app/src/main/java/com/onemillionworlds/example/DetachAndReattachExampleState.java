    ...
    public void update(float tpf){
        ...
        if (reattachCountDown){
            ...
            if (reattachTimer < 0){
                ...
                HandSpec handSpec = Handspec.handSpec().toBuilder()
                        ...
                        .build();
                XrBaseAppState xrAppState = new XrAndroidAppState();
                ...
                getStateManager().attach(new XrActionAndroidAppState(Manifest.manifest(), ActionSets.MAIN));
